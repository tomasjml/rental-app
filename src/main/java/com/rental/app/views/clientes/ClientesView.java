package com.rental.app.views.clientes;
...
@PageTitle("Clientes")
@CssImport("styles/views/clientes/clientes-view.css")
public class ClientesView extends Div implements AfterNavigationObserver {
    @Autowired
