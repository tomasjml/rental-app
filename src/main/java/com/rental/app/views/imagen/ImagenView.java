package com.rental.app.views.imagen;
...
import com.vaadin.flow.router.Route;import com.rental.app.views.main.MainView;


@Route(value = "imagen-cliente", layout = MainView.class)
@PageTitle("Imagen")
@CssImport(value = "styles/views/imagen/imagen-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class ImagenView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public ImagenView() {
        setId("imagen-view");
        addClassName("imagen-view");
        setSizeFull();
        grid.setHeight("100%");
