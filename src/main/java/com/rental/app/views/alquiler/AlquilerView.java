package com.rental.app.views.alquiler;

import org.springframework.beans.factory.annotation.Autowired;
import com.rental.app.backend.BackendService;
import com.rental.app.backend.Employee;
...
@Route(value = "alquiler", layout = MainView.class)
@PageTitle("Alquiler")
@CssImport("styles/views/alquiler/alquiler-view.css")
public class AlquilerView extends Div implements AfterNavigationObserver {
    @Autowired
