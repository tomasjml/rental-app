package com.rental.application.views.agregar;
...
@Route(value = "agregar", layout = MainView.class)
@PageTitle("Agregar")
@CssImport("styles/views/agregar/agregar-view.css")
public class AgregarView extends Div {
