package com.rental.application.views.userpicture;
...
import com.vaadin.flow.router.Route;import com.rental.application.views.main.MainView;


@Route(value = "user-picture", layout = MainView.class)
@PageTitle("User picture")
@CssImport(value = "styles/views/userpicture/userpicture-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class UserpictureView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public UserpictureView() {
        setId("userpicture-view");
        addClassName("userpicture-view");
        setSizeFull();
        grid.setHeight("100%");
