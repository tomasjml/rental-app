package com.rental.application.views.equipos;
...
@PageTitle("Equipos")
@CssImport("styles/views/equipos/equipos-view.css")
public class EquiposView extends Div implements AfterNavigationObserver {
    @Autowired
