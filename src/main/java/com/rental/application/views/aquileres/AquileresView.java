package com.rental.application.views.aquileres;

import org.springframework.beans.factory.annotation.Autowired;
import com.rental.application.backend.BackendService;
import com.rental.application.backend.Employee;
...
@PageTitle("Aquileres")
@CssImport("styles/views/aquileres/aquileres-view.css")
public class AquileresView extends Div implements AfterNavigationObserver {
    @Autowired
    ...
    public AquileresView() {
        setId("aquileres-view");
        // Configure Grid
        employees = new Grid<>();
